...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex flex-col justify-center items-center bg-[#344151] gap-10">
      ...
      <div className="flex bg-white items-center justify-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
      ...
      <button onClick={resetHandler} className="text-white bg-[#0398d4] py-2 px-5 rounded-sm text-lg">
        Reset
      </button>
    </div>
  );
